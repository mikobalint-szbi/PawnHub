                ...
                .pageContainer {
                    ...
                    .pageTags {
                        ...
                        .pageTag {
                            ...
                            box-shadow: 1px -1px 1px rgba($color: black, $alpha: 0.3) inset,
                            -1px -1px 1px rgba($color: black, $alpha: 0.3) inset;
                            font-weight: 300;
                        ...
                        .pageTag.active {
                            ...
                            cursor: default;
                            box-shadow: 1.2px -1px 1.1px rgba($color: black, $alpha: 0.3),
                                        -1.2px -1px 1.1px rgba($color: black, $alpha: 0.3);
